...
const PRODUCTS = {
  ...
  flowstate: {
    name: 'FlowState',
    stripePriceId: process.env.STRIPE_PRICE_FLOWSTATE || 'price_1TTkZ3DitrGINm9mZkkholBn',
    statementDescriptorSuffix: 'FLOWSTATE',
    blobUrl: process.env.FLOWSTATE_BLOB_URL || 'https://kuownxqapvwc1svu.private.blob.vercel-storage.com/Plugins/FlowState-1.0.0.zxp',
    downloadFilename: 'FlowState-1.0.0.zxp',

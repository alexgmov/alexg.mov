...
const PRODUCTS = {
  ...
  sidestream: {
    ...
    blobUrl: process.env.SIDESTREAM_BLOB_URL || 'https://kuownxqapvwc1svu.private.blob.vercel-storage.com/Plugins/Sidestream-1.0.2.zxp',
    downloadFilename: 'Sidestream-1.0.2.zxp',

...
const PRODUCTS = {
  ...
  sidestream: {
    ...
    blobUrl: process.env.SIDESTREAM_BLOB_URL || 'https://kuownxqapvwc1svu.private.blob.vercel-storage.com/sidestream/1.0.4/Sidestream-1.0.4-Mac-ZXP-Installer.dmg?download=1',
    downloadFilename: 'Sidestream-1.0.4-Mac-ZXP-Installer.dmg',
